...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            ADTU: ["Sem-5"],
            books: ["Ugly Love.pdf", "Elon Musk: How the Billionaire CEO of SpaceX.pdf", "Atomic Habits.pdf", "A Little Life.pdf"],
            skills: ["Pentesting","CTFs","React.js", "Flutter", "node.js", "SQL", "Bash"],
            projects: ["yash-ubuntu-portfolio", "ImageHunt", "SGrade"],
            interests: ["Software Engineering", "Red-Team", "Pentersting"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">yash@thegreat</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/yash@thegreat")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-yash, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
